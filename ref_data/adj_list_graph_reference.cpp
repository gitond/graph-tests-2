/*
	...
	This file's purpose is to act as a reference on how to do different
	operations with the adj_list_graph file structure. It is a copy of
	main.cpp at the time of its creation, but main.cpp is expected to be
	constantly modified. This isn't expected to be modified, compiled or
	run. The purpose of this file is to act as a light documentation of
	sorts.
*/
